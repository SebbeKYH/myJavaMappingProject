...
public class adress3Challenge {
    public void theChallenge3(){
        //Creating the rooms.
        challengeRoom room1ProgrammerSchool = new challengeRoom("The Security Area", "When you enter the building you " + "\n" +
        ...
        challengeRoom room2ProgrammerSchool = new challengeRoom("The Post Box ", "Jonathan needs some help fitting the" + "\n" +
        ...
        challengeRoom room3ProgrammerSchool = new challengeRoom("File cabinetts", "Your meeting with Jonathan makes you " + "\n" +
        ...
        readRoomMap("./src/TextFiles/adress3Map", "Could not read the map");
        ...
        while ((caseOneFinished & caseTwoFinished & caseThreeFinished & caseFourFinished) == false){
            switch (roomInput.nextInt()) {
                case 1:
                    ...
                    System.out.println("You have entered " + room1ProgrammerSchool.roomName + room1ProgrammerSchool.roomDescription +
                            room1ProgrammerSchool.roomChallenge);
                    //readJonathansLetter();
                    caseOneFinished = true;
                    break;
                case 2:
                    System.out.println("You have entered " + room2ProgrammerSchool.roomName + room2ProgrammerSchool.roomDescription +
                            room2ProgrammerSchool.roomChallenge);
                    ...
                    break;
                case 3:
                    System.out.println("You have entered " + room3ProgrammerSchool.roomName + room3ProgrammerSchool.roomDescription +
                            room3ProgrammerSchool.roomChallenge);
                ...
                case 4:
                    ...
                    System.out.println("You have entered " + room4ProgrammerSchool.roomName + room4ProgrammerSchool.roomDescription +
                            room4ProgrammerSchool.roomChallenge);
    ...
    private void welcomeText() {
        System.out.println("**************************************************");
        System.out.println("Welcome to Programmer School. Have a close look at the overlay of the map."+"\n"+
